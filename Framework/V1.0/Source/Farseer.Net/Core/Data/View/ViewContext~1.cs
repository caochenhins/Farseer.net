...
namespace FS.Core.Data.View
{
        ...
        where TPo : ViewContext<TPo, TVo>, new()
    {
        ...
        public ViewContext(int dbIndex) : base(dbIndex) { Init(); }
        ...
        public ViewContext(string connectionString, DataBaseType dbType = DataBaseType.SqlServer, int commandTimeout = 30) : base(connectionString, dbType, commandTimeout) { Init(); }

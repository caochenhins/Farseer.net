...
namespace FS.Utils.Web
{
    ...
    public abstract class Req
    {
        ...
        public static string GetPageName()
        {
            ...
            var url = context.Request.FilePath;
            url = WebForm.Url.GetPageName(url);
            return url;
        }
        ...
        public static string GetParams()
        {
            ...
            var parm = WebForm.Url.GetParams(context.Request.RawUrl).Split('&');
        ...
        {
            return HttpContext.Current == null ? defValue : WebForm.Url.UrlDecode(HttpContext.Current.Request.QueryString[parmsName] ?? string.Empty).ConvertType(defValue);
        }
        ...
        {
            if (string.IsNullOrWhiteSpace(url)) { url = Cookies.Get(SystemConfigs.ConfigInfo.Cookies_CallBack_Url); }
